 ...
 * @LastEditTime: 2024-05-02 19:16:57
 * @LastEditors: liutq
 * @Reference: 
-->
<template>
  <div class="thisBox">
    <div class="displayArea">
      ...
      <div class="MessageLeader">
        <leaderHeader :title="userStore.unitData[1].name + '物资登记管理系统'" />
      </div>
      <!-- 内容列表中间整体部分 -->
              ...
              >
                <div style="color: #171818">
                  <AssetsSystemMain
                    ...
                    :addTab="addTab"
                  ></AssetsSystemMain>
                  <AssetsClassify v-if="a.action == '分类管理'"></AssetsClassify>
                  <AssetsData :addTab="addTab" v-if="a.action == '数据录入'"></AssetsData>
                </div>
              </lay-tab-item>
            </lay-tab>
          </div>
...
import LeftLeader from "@/components/AssetsSystem/LeftLeader.vue";
import AssetsSystemMain from "@/components/AssetsSystem/AssetsSystemMain.vue";
import AssetsClassify from "@/components/AssetsSystem/AssetsClassifyAdmin.vue";
import AssetsData from "@/components/AssetsSystem/AssetsDataAdmin.vue";
