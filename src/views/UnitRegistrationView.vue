            ...
            >
              ...
              >
                <div style="color: #171818">
                  <unitComponent v-if="a.id == '1'" :addTab="addTab"></unitComponent>
...
import unitComponent from "@/components/unitComponent/unitComponent.vue";

// 页面卡片部分--------------------------------------------
const layTableItenCurrent = ref("1");
let layTableIndex = 1;
const arrLayTable = ref([
  { id: "1", title: "项目管理", option: {}, closable: false },
  // { id: "2", title: "权限管理" },
  // { id: "3", title: "支付管理" },
]);
