            ...
            >
              ...
              >
                <div style="color: #171818">
                  <nonitoring v-if="a.action == '农安监测'" :addTab="addTab"></nonitoring>
...
import nonitoring from "@/components/AgriculturalMonitoring/monitorMain.vue";
...
const arrLayTable = ref([
  { id: "1", title: "农安监测", action: "农安监测", option: {}, closable: false },
  // { id: "2", title: "权限管理" },
  // { id: "3", title: "支付管理" },
]);
